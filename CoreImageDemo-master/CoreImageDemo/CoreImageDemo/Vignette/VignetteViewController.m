...
- (void)viewDidLoad {
    ...
    NSURL *mask1URL = [[NSBundle mainBundle] URLForResource:@"mask1" withExtension:@"png"];
    CIImage *maskImage1  = [CIImage imageWithContentsOfURL:mask1URL];
    
    NSURL *mask2URL = [[NSBundle mainBundle] URLForResource:@"mask2" withExtension:@"png"];
    CIImage *maskImage2 = [CIImage imageWithContentsOfURL:mask2URL];
    
    [self.vignetteFilter setValue:_inputImage forKey:@"inputImage"];
    [self.vignetteFilter setValue:maskImage1 forKey:@"mask1"];
    [self.vignetteFilter setValue:maskImage2 forKey:@"mask2"];
    
//    NSNumber *mask1Exp;
//    NSNumber *mask2Exp;
//    NSNumber *globalExp;
    [self.vignetteFilter setValue:@2.0 forKey:@"globalExp"];
    [self.vignetteFilter setValue:@1.0 forKey:@"mask1Exp"];
    [self.vignetteFilter setValue:[NSNumber numberWithFloat:-1.0] forKey:@"mask2Exp"];
